...
const routes: Routes = [
  Route.withShell([
    {
      ...
      children: [
        ...
        },
        {
          ...
          data: { title: 'Login Activities', breadcrumb: 'Login Activities' },
          loadChildren: () =>
          import('./login-activities/login-activities.module').then(
          (m) => m.LoginActivitiesModule
          ),
        },
        {
          ...
          loadChildren: () =>
            import('./campaign-builder/campaign-builder.module').then(
              (m) => m.CampaignBuilderModule
            ),
        },
        {
          path: 'codes',
  ...
  { path: 'login-activities', loadChildren: () => import('./login-activities/login-activities.module').then(m => m.LoginActivitiesModule) },
  { path: 'campaign-builder', loadChildren: () => import('./campaign-builder/campaign-builder.module').then(m => m.CampaignBuilderModule) }
