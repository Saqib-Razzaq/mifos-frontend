  ...
  Route.withShell([
    {
      ...
      children: [
        ...
        {
          path: 'loans',
          data: { title: 'Client Loans', breadcrumb: 'Loans', routeParamBreadcrumb: false },
          loadChildren: () => import('../clients/clients-loans/clients-loans.module').then(m => m.ClientsLoansModule)
        },
        {
          path: 'savings',
          data: { title: 'Client Savings', breadcrumb: 'Savings', routeParamBreadcrumb: false },
          loadChildren: () => import('../clients/clients-savings/clients-savings.module').then(m => m.ClientsSavingsModule)
        },
        {
          path: 'shares',
          data: { title: 'Client Shares', breadcrumb: 'Shares', routeParamBreadcrumb: false },
          loadChildren: () => import('../clients/clients-shares/clients-shares.module').then(m => m.ClientsSharesModule)
        },
        {
          path: 'fixeddeposits',
          data: { title: 'Client Fixed Deposits', breadcrumb: 'Fixed Deposits', routeParamBreadcrumb: false },
          loadChildren: () => import('../clients/clients-fixeddeposits/clients-fixeddeposits.module').then(m => m.ClientsFixedDepositsModule)
        },
        {
          path: 'timedeposits',
          data: { title: 'Client Time Deposits', breadcrumb: 'Time Deposits', routeParamBreadcrumb: false },
          loadChildren: () => import('../clients/clients-timedeposits/clients-timedeposits.module').then(m => m.ClientsTimeDepositsModule)
        },
        {
          path: 'create',
